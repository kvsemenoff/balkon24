<?php 
/*
Template Name: Тёплое остекление
*/
?>
<?php get_header(); ?>
...
<div class="di-bg-wrap">
	...
	<div class="row">
		<div class="wrap-first-cold">
			...
			<div class="col-md-6">
				<div class="cold-wrap-text warm-wrap-text">
					<span class="r-text">
						При теплом остеклении температура на балконе будет такой же, как и комнате (около 23 градусов), что позволяет использовать такой балкон, как отдельную комнату или совмещать с жилой зоной.<br><br>

Остекление балкона производится такими же пластиковыми окнами, как и в квартире, что обеспечивает высокий уровень сбережения тепла.
					</span><br><br>
					<span class="b-text">
						Узнайте больше о теплом остеклении по номеру:
					</span>
				</div>
				<div class="cold-phone warm-phone">
...
<div class="second-cold">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 class="db-our-h1 di-h1">преимущества тёплого остекления</h1>
				<div class="cold-p">
...
<div class="di-cold-our-works">
	<section class="section section_padding">
		<div class=" container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="db-our-h1">Примеры тёплого остекления</h1>
